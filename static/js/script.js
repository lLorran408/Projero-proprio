...
const updateUI = (user) => {
    if (user) {
        ...
        const avatarImg = `<img src="${user.photoURL || '/static/imagens/user.png'}" alt="${user.displayName || 'Avatar do Usuário'}" class="rounded-circle avatar-sm" referrerpolicy="no-referrer">`;
        ...
        const icon = `<img src="/static/imagens/user.png" alt="Logue-se com o Google" class="rounded-circle avatar-sm">`;
